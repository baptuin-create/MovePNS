...
────────────────────────────────────────────── */
const GAS_URL = "https://script.google.com/macros/s/AKfycbzBqf6slRPiDX8qhJXz7-4xm57BO7uw1QBcGEeM2zbWM2yZjt81jGBiccUPnBV8XlB8/exec";
...
function initImpactPage() {
  ...
  setTimeout(() => {
    prog.style.strokeDashoffset = circumference * (1 - 0.72);
  }, 200);
